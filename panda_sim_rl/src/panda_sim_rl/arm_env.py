...
class Viewer(pyglet.window.Window):
    ...
    def _update_arm(self):
        ...
        arm1_coord = (self.center_coord[0], self.center_coord[1], self.arm_info[0, 2], self.arm_info[0, 3])  # (x0, y0, x1, y1)
        arm2_coord = (self.arm_info[0, 2], self.arm_info[0, 3], self.arm_info[1, 2], self.arm_info[1, 3])  # (x1, y1, x2, y2)
